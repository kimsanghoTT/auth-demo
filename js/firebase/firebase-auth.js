...
import {
    ...
    signOut, //로그아웃
    deleteUser, //탈퇴
    reauthenticateWithCredential, // 탈퇴전 재인증
    reauthenticateWithPopup, // 탈퇴시 소셜 로그인 계정 재인증
    EmailAuthProvider // 이메일 인증용 provider
...
export const resetPassword = async (email) => {
  await sendPasswordResetEmail(auth, email); //해당 이메일 주소로 비밀번호 재설정 링크 보냄
